...
import copy
import collections
from algorithms.dqn_cpy import DQN
...
class MCTS:
    def __init__(self, value_fn, policy_fn, rollout_fn, n_playout=50, limit=50, lambda_val=1):
        ...
        # policy function when player_id = 1
        graph_2 = tf.Graph()
    ...
    def playout(self, time_step, env):
        ...
        # print(cur_player)
        action_probs = self._policy_fn[cur_player]._get_policy(info_state, legal_actions)
        # print(action_probs)
